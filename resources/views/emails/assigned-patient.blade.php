                ...
                <table width="600" cellpadding="0" cellspacing="0"
                        ...
                        <td style="padding:40px;">
                            ...
                            <table width="100%" cellpadding="10" cellspacing="0"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ \Carbon\Carbon::parse($appointment->appointment_date ?? $appointment->requested_date)->format('F d, Y') }}
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td align="center" style="background:#f9fafb;padding:20px;color:#6b7280;font-size:13px;">
                            ...
                            <br>
                            Thank you for providing care to our patients.
                        </td>
                    </tr>
